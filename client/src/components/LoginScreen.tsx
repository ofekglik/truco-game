      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative bg-[#0d1117] border-2 border-yellow-500/30 rounded-3xl p-8 shadow-2xl backdrop-blur-sm max-h-[90vh] overflow-y-auto">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-400 text-sm">בחרו דרך כניסה כדי להתחיל לשחק</p>
          </div>

          {/* Error message */}
          {error && (
            <div className="mb-6 bg-red-900/30 border border-red-500/60 rounded-xl p-4 text-center">
          ...
          {showGuestForm ? (
            <div className="space-y-5 animate-in fade-in duration-300">
              ...
              <div className="text-center">
                ...
                <h2 className="text-yellow-300 font-semibold">כניסה אורח</h2>
              </div>
            ...
            <div className="space-y-4 animate-in fade-in duration-300">
              ...
              <button
                ...
                className="w-full py-4 px-6 bg-gradient-to-r from-green-500 to-green-400 hover:from-green-400 hover:to-green-300 text-gray-900 font-bold rounded-2xl text-lg transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-green-500/50"
              >
                🎮 שחק כאורח
              </button>
          ...
          <div className="mt-8 pt-6 border-t border-yellow-500/20 text-center">
            ...
            <p className="text-gray-500 text-xs mt-2">כניסה אורח זמנית • לא נשמר במסד נתונים</p>
          </div>
        </div>
      </div>
    </div>
